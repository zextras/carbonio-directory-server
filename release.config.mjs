...
export default {
  ...
  plugins: [
    ...
    [
      ...
      {
        "prepareCmd": "sed -i 's|<revision>.*</revision>|<revision>${nextRelease.version}</revision>|' pom.xml && sed -i 's/^pkgver=.*/pkgver=\"${nextRelease.version}\"/' directory-server/PKGBUILD"
      }
    ],
    [
      '@semantic-release/git',
      {
        assets: ['pom.xml', 'directory-server/PKGBUILD'],
